...
2. type
3. payload
4. router / reducer / CENTRAL FUNCTION 
5. initial state 
...
### Random
- such a cool use case!!! Have an array prevStates in the store and any change push the last version and then add a revert feature 